        ...
        <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="bg-gradient-to-r from-sky-600 to-cyan-500 px-6 py-10 text-white sm:px-8">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-sky-50 sm:text-base">
              Learn, track progress, and manage lectures from one modern LMS
              dashboard.
            </p>
              ...
              <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
                    Enroll in this course to access lectures, watch videos,
              ...
              {!canViewLectures ? (
                ...
                <div className="flex min-h-[420px] flex-col items-center justify-center text-center">
                  ...
                  <p className="mt-3 max-w-md text-sm leading-6 text-slate-600">
                    Enroll in this course to watch lectures and track your
                    learning progress.
                  </p>
                ...
                <div>
                  ...
                  <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-black aspect-video">
